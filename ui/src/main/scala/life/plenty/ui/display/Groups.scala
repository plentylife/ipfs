...
class AnswerGroup(private val _withinOctopus: Hub) extends GroupedChildDisplay(_withinOctopus) {
...
class QuestionModuleGroup(private val _withinOctopus: Hub) extends GroupedModularDisplay(_withinOctopus) {
